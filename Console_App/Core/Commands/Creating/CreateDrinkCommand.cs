...
namespace Console_App.Core.Commands.Creating
{
    ...
    {
        public CreateDrinkCommand(IEngine calorieCounterEngine)
        ...
        public override string Execute(IList<string> parameters)
        {
            ...
            catch
            {
                throw new CommandParseЕxception(
                    "The correct format for CreateDrink is {name}{caloriePer100g}{proteinPer100g}{carbsPer100g}{fatPer100g}{sugar}{fiber}");
            }
