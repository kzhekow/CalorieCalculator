namespace CalorieCounterEngine.Models.Drinks
{
    ...
    public class CustomDrink : Product 
    {
        ...
        /// </summary>
        public CustomDrink(string name, decimal weightInMl, int calories, int protein, int carbs, int fat, int sugar, int fiber) : base(name, weightInMl, calories, protein, carbs, fat, sugar, fiber)
        {
        }
    }
}
