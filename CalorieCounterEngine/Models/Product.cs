...
namespace CalorieCounterEngine.Models
{
    ...
    public abstract class Product : IProduct, IWeight
    {
        ...
        /// <summary>
        /// Product constructor. Every new instantiated product must have a name and weight. New products can also contain calories, protein, carbs, fat, sugar and fiber.
        /// </summary>
