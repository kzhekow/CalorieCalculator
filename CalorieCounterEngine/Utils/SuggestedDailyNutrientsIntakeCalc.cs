...
namespace CalorieCounter.Utils
{
    public class SuggestedDailyNutrientsIntakeCalc : ISuggestedDailyNutrientsIntakeCalc
    {
        ...
        public double CalculateSuggestedDailyProteinIntake(IGoal currentGoal,
            IRestingEnergyCalculator restingEnergyCalculator)
        {
            ...
            {
                case GoalType.loseweight:
                    suggestProteinIntake =
                        0.4 * CalculateSuggestedDailyCalorieIntake(currentGoal, restingEnergyCalculator) / 4;
                    break;
                case GoalType.maintainweight:
                    suggestProteinIntake =
                        0.3 * CalculateSuggestedDailyCalorieIntake(currentGoal, restingEnergyCalculator) / 4;
                    break;
                case GoalType.gainweight:
                    suggestProteinIntake =
                        0.3 * CalculateSuggestedDailyCalorieIntake(currentGoal, restingEnergyCalculator) / 4;
